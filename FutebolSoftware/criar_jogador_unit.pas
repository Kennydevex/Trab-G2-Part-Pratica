...
begin
     sqlCriarJogador := 'INSERT INTO jogadores(nome, apelido, numero, data_nascimento, telefone, email, nif, id_equipa) VALUES (:nome, :apelido, :numero, :data_nascimento, :telefone, :email, :nif, :id_equipa)';
